...
def visualisation_distributions(smiles_list, output_filename):
    """
    Visualize density distributions of Lipinski descriptors for a list of SMILES strings and save the results to a CSV file.
    ...
    for smiles in smiles_list:
        descriptor = lipinski_descriptors(smiles)
...
smiles_list_to_check = ["CCO", "C1=CC=CC=C1", "CC(C)(C)C(=O)O", "CCN", "C(CCCCCCCC)CCCCCCCC(=O)O", "Invalid"]
output_filename = 'subset_50000_descr.csv'
valid_smiles = visualisation_distributions(smiles_list_to_check, output_filename)
